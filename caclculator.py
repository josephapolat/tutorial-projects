...
disp = Entry(window, readonlybackground="white")
...
#Set up buttons
delete = Button(window, text="<", bg="#ECF2F5", relief=FLAT, command= on_delete_button_click)
...
plusMinus.grid(column=0, row=5, sticky="nesw")

zero = Button(window, text = "0", bg="#ECF2F5", relief=FLAT, command=lambda: on_button_click("0"))
zero.grid(column=1, row=5, sticky="nesw")

dot = Button(window, text = ".", bg="#ECF2F5", relief=FLAT, command=lambda: on_button_click("."))
dot.grid(column=2, row=5, sticky="nesw")

equals = Button(window, text = "=", bg="#ECF2F5", relief=FLAT, command=lambda: on_button_click("7"))
equals.grid(column=3, row=5, sticky="nesw")
